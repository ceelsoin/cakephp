...
class I18n
{
     ...
     * @return void
     */
    public static function setTranslator(string $name, callable $loader, $locale = null): void
    {
     ...
     */
    public static function getTranslator($name = 'default', $locale = null): TranslatorInterface
    {
        $translators = static::translators();
